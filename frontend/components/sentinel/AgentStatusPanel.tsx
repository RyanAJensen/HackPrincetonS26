...
const UNITS: Record<string, {
  ...
  incident_parser: {
    role: "Situation Unit",
    mission: "Confirms location, hazards, and medical impact estimates for triage.",
    impact: "Aligns EMS, fire, and hospitals on the same patient and access picture.",
    deliverables: ["Medical Impact (population / injuries)", "Confirmed Facts", "Critical Unknowns"],
    completedNote: "Situation and medical impact assessed",
  },
  risk_assessor: {
    role: "Threat Analysis Unit",
    mission: "Ranks healthcare and operational risks including EMS delay and capacity.",
    impact: "Surfaces replan triggers before transport or triage fails.",
    deliverables: ["Healthcare / EMS Risks", "Priority Threats", "Replan Triggers"],
    completedNote: "Threat analysis complete",
  },
  action_planner: {
    role: "Operations Planner",
    mission: "Produces time-phased EMS actions, triage sectors, and patient transport.",
    impact: "Converts triage priorities into deployable tasks and routes.",
    deliverables: ["Immediate EMS / Extraction", "Triage Sector Setup", "Hospital Coordination", "Transport Plan"],
    completedNote: "Medical response plan generated",
  },
  communications: {
    role: "Communications Officer",
    mission: "Drafts EMS briefs, hospital notifications, and public safety advisories.",
    impact: "Keeps field units, receiving facilities, and the public aligned.",
    deliverables: ["EMS Brief", "Hospital Notification", "Public Advisory", "Leadership Update"],
    completedNote: "Healthcare comms drafted",
  },
};
